...
export default function HomePage() {
    const features = [
        { icon: <Users />, title: "Real-time Collaboration", description: "Work together seamlessly with live code editing and live cursor support.", titleColor: "text-yellow-400" },
